    ...
    {April 2022 -} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {
            ...
            imagery) and produces spatial summary statistics, yielding time series collated
            from hundreds of source images per area of interest. Service integrates with 25+ public
            imagery products.
        }
      \end{cvitems}
    }
